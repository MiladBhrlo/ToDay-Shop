...
using ToDay_Shop.Orders.Endpoints.WebApp.Infrastructor.Extensions.DependencyInjection.Abstractions;

namespace ToDay_Shop.Orders.Endpoints.WebApp.Infrastructor.Extensions.DependencyInjection;
...
public static class Extensions
{
        ...
        params string[] assemblyNamesForSearch)
    {
        ...
        services.AddApplicationServices(assemblies).AddApplicationDataAccess(assemblies).AddCustomeDepenecies(assemblies);
        return services;
    }
